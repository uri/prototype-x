...
---------
     ...
     exit, exit!, fail, fork, format, getc, gets, global_variables,
     gsub, gsub!, iterator?, lambda, load, local_variables,
     log_open_files, loop, method_missing, not_implemented, open,
     ...
     set_trace_func, silence_stream, silence_warnings, singleton_class,
     sleep, split, sprintf, srand, sub, sub!, suppress,
     suppress_warnings, syscall, system, test, throw, trace_var, trap,
...
-----------------
     ...
     methods, nil?, object_id, or_ask, presence, present?,
