...
-----------------
     ...
     method_missing, not_implemented, open, open_uri_original_open,
     ...
     sub, sub!, suppress, suppress_warnings, syscall, system, test,
     throw, trace_var, trap, untrace_var, warn, with_warnings, y
